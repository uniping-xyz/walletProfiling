...
async def eth_erc1155_1day( skip, limit):
    url = "https://api.zettablock.com/api/v1/dataset/sq_d0c52337ca3b40fa8a60a49d5cd76c9d/graphql" #new_token
...
async def eth_erc1155_3day(skip, limit):
    url = "https://api.zettablock.com/api/v1/dataset/sq_60b4dffecdca4573830154985cb53ace/graphql" #new_token
...
async def eth_erc1155_7day(skip, limit):
    url = "https://api.zettablock.com/api/v1/dataset/sq_f63edce5d5ab4eecbc2d5d8fc3dccd0a/graphql" #new_token
    # url="https://api.zettablock.com/api/v1/dataset/sq_099afff349cc4bc49cb3dec5929aeafd/graphql"
    # oldurl ="https://api.zettablock.com/api/v1/dataset/sq_ea76f6340f0841c9ac4e3bea7ab3f71a/graphql"
    query = """{
        records(limit:%s, skip: %s 
