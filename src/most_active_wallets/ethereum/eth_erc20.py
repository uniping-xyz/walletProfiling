...
async def eth_erc20_1day( skip, limit):
    url = "https://api.zettablock.com/api/v1/dataset/sq_bd9cb0e96c3a4d39ab30c0c9ec2c4d76/graphql" #new_token
...
async def eth_erc20_3day( skip, limit):
    url = "https://api.zettablock.com/api/v1/dataset/sq_ba20af929af4492ab0ac9025df740c5c/graphql" #new_token
    # url="https://api.zettablock.com/api/v1/dataset/sq_4438dd2d05574645943ccf37a7e33bb1/graphql"
    # oldurl = "https://api.zettablock.com/api/v1/dataset/sq_f7279f447ff24055b7bbdaa607045b56/graphql"
    query = """{
        records(limit:%s, skip: %s 
...
async def eth_erc20_7day(skip, limit):
    url = "https://api.zettablock.com/api/v1/dataset/sq_3e9a1bbeb5a44ae49038681236e969dd/graphql" #new_token
