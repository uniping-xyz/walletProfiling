...
async def eth_erc721_1day( skip, limit):
    url = "https://api.zettablock.com/api/v1/dataset/sq_f4cab2c88df74bea97b037f5d2e01172/graphql"
...
async def eth_erc721_3day(skip, limit):
    url = "https://api.zettablock.com/api/v1/dataset/sq_dbcbfa2523154e69ab0f546d4369abab/graphql"
...
async def eth_erc721_7day(skip, limit):
    url = "https://api.zettablock.com/api/v1/dataset/sq_e8eeac0030fa4f4b9f8c03aa9a0b3294/graphql"
